...
public class MarketPlaceEventProducer {
  ...
  // TODO - exercise 2 - Create at least 2 headers and send them as part of the event. Hint: explore producerRecord API

  // TODO - exercise 3  - publish an event into kafka with a key and check how they end up into partitions
}
